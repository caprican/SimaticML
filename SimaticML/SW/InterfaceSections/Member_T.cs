...
namespace SimaticML.SW.InterfaceSections
{
    ...
    public class Member_T : IXmlSerializable
    {
        [XmlAttribute]
                ...
                while (reader.MoveToContent() == XmlNodeType.Element)
                {
                    switch (reader.Name)
                    {
                        case "BooleanAttribute":
                            var booleanAttr = new Common.BooleanAttribute_T();
                            booleanAttr.ReadXml(reader);
                            attributes.Add(booleanAttr);
                            break;
                        case "IntegerAttribute":
                            var integerAttr = new Common.IntegerAttribute_T();
                            integerAttr.ReadXml(reader);
                            attributes.Add(integerAttr);
                            break;
                        case "RealAttribute":
                            var realAttr = new Common.RealAttribute_T();
                            realAttr.ReadXml(reader);
                            attributes.Add(realAttr);
                            break;
                        case "StringAttribute":
                            var stringAttr = new Common.StringAttribute_T();
