...
namespace SimaticML.Ident
{
    ...
    public class MultiInstAccessType : SimaticStorageType
    {
        [XmlAttribute]
        ...
        [XmlAttribute]
        public uint ClassicAbsOffset { get; set; }

        [XmlAttribute]
        public uint RetainAbsOffset { get; set; }

        [XmlAttribute]
        public uint VolatileAbsOffset { get; set; }
